...
class RepairTests(unittest.TestCase):
    ...
    def test_an_occupied_destination_is_never_overwritten(self):
        """A second copy buried under some other folder wants the name a real
        episode already has. The real one wins by not being touched."""
        ...
        self.assertIn('already there', plan['blocked'][0]['reason'])

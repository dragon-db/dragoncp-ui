...
import { IconRefresh, IconChevronDown, IconChevronUp, IconServer } from "@tabler/icons-react";
        ...
        <div className="space-y-4">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              {/* Remote Storage */}
              {remoteStorage && <DiskWidget disk={remoteStorage} variant="remote" />}

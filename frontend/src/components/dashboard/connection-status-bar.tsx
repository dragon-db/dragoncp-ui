      ...
      <div className="flex items-center gap-3">
        <span
          className={cn(
            ...
            connecting && "animate-pulse bg-blue-500",
      ...
      <div className="flex items-center gap-2">
        {onCollapseAll && (
          <Button
            variant="outline"
            size="sm"
            className="h-8 gap-1.5 border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-white"
        ...
        {connected && onExtendSession && (
          <Button
            variant="outline"
            size="sm"
            className="h-8 gap-1.5 border-neutral-700 text-neutral-300 hover:bg-neutral-800 hover:text-white"
        ...
        {onDisconnect && connected && (
          <Button
            variant="outline"
            size="sm"
            className="h-8 gap-1.5 border-neutral-700 text-neutral-300 hover:bg-neutral-800 hover:text-red-300"
